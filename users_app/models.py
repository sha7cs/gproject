...
class UsersModel(models.Model):
    ...
    created_at = models.DateTimeField(auto_now_add=True,null=True)  # Automatically set when a user is created
    updated_at = models.DateTimeField(auto_now=True,null=True)  # Auto-updates when modified
